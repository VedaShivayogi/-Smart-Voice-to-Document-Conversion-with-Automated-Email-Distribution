...
app.config['MAIL_USERNAME'] = 'vedaram2002@gmail.com'
app.config['MAIL_PASSWORD'] = 'zrtlytzthpzpungy'   # Gmail App Password
app.config['MAIL_DEFAULT_SENDER'] = 'vedaram2002@gmail.com'
